...
{\aufgabe} Simplify the following expressions,
\begin{equation}
  \label{eq:zaiquahu}
  \left(64^{\frac{4}{3}}\right)^{-\frac{1}{2}}\hspace{.5in}(16\cdot{}81)^{-\frac{1}{4}}\hspace{.5in}\left(\frac{3^{\frac{1}{2}}}{2^{\frac{1}{3}}}\right)^{4}\hspace{.5in}\sqrt[3]{108}-\sqrt[3]{32}\notag
\end{equation}
